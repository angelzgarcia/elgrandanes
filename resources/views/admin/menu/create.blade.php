...
<x-layouts.admin-layout>
    <div class="menu-form-container">
        ...
        <form action="{{ route('menu.store') }}" method="post" autocomplete="off" enctype="multipart/form-data" id="form">
            @csrf
            ...
            <button type="submit" id="submit-menu" class="font-black">
                Subir archivo
