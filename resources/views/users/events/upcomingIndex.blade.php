...
<x-layouts.user-layout titulo="El Gran Danés Café - Bar | Próximos Eventos">
    ...
    {{-- EVENTOS FIJOS, EVENTOS SEMANALES --}}
    {{--
        fecha
        horario
        costo
        genero
        reservación true false
        cupo del evento con reservacion
    ...
    <div class="upcoming-events-section">
        <div class="img-upc-event">
            <img src="{{ img_u_url('474199961_122121909188614369_3903254430887157829_n.jpg') }}" alt="next-upcoming-event">
        </div>
        ...
        <div class="data-upc-event">
            ...
            <div class="details">
                ...
                <p>
                    ...
                    <span>
                        {{-- 54 --}}
                        Cupo disponible hasta completar aforo.
                    </span>
                </p>
                <hr>
                <p>
        ...
        <div class="list-of-events">
            <div class="upcoming-list-events">
                <h3 class="font-black">Eventos de la semana</h3>

                <div class="event">
                    <div class="event-img">
                        <a href="">
                            <img src="{{ img_u_url('474199961_122121909188614369_3903254430887157829_n.jpg') }}" alt="upcoming-event">
                        </a>
                    </div>
                    <p>
                        {{ date('D, d M Y') }}
                ...
                <div class="event">
                    <div class="event-img">
                        <a href="">
                            <img src="{{ img_u_url('474512864_122121590810614369_6781195875015987048_n.jpg') }}" alt="upcoming-event">
                        </a>
                    </div>
                    <p>
                        {{ date('D, d M Y') }}
            ...
            <div class="list-fixed-events">
                <h3 class="font-black">Eventos fijos</h3>
